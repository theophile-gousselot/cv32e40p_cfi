...
`endif
`ifdef CS4
    assign cs_vector_o = {rega_used_o, regb_used_o, regc_mux_o, regc_used_o, regfile_alu_we_dec_o, regfile_alu_we_o};
`endif
`ifdef CS5
...
`endif
`ifdef CS6
    assign cs_vector_o = {regfile_alu_we_o};
`endif
`ifdef CS7
