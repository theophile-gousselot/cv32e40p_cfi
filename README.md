# OpenHW Group CORE-V CV32E40P IP
...
The purpose of this repository is to be cloned by the `core-v-verif-fpga` project [https://github.com/theophile-gousselot/execution-integrity-down-to-control-signals.git](https://github.com/theophile-gousselot/execution-integrity-down-to-control-signals.git).
